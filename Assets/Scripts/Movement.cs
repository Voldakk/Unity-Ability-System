//
// CrankyRigidBodyController with minor modifications
// https://forum.unity3d.com/threads/rigidbody-fps-controller.257353/
//
...
public class Movement : MonoBehaviour
{
    ...
    [HideInInspector]
    public float AccelRate = 100.0f;
    [HideInInspector]
    public float DecelRate = 100.0f;
    [HideInInspector]
    public float AirborneAccel = 20.0f;
    [HideInInspector]
    ...
    void Awake()
    {
        ...
        AccelRate = stats.AccelRate;
        DecelRate = stats.DecelRate;
        AirborneAccel = stats.AirborneAccel;
        JumpSpeed = stats.JumpSpeed;
        FudgeExtra = stats.FudgeExtra;
    ...
    void OnCollisionExit(Collision collision)
    {
        ...
        {
            if (collisions[i] == collision.gameObject || collisions[i].gameObject == null)
        ...
        if(collision.gameObject != null)
            ...
            contactPoints.Remove(contactPoints.FirstOrDefault(x => x.Value == collision.contacts).Key);
    }
